...
export class DiscordId implements IValidate , IEquatable<DiscordId> , IValueObject<number> {
    value : number;

    constructor(discordId : number) {
    ...
    isValid(): boolean {
        ...
        try {
            ...
            new Date((this.value / 4194304) + 1420070400000)
        } catch {
            return false
        }
